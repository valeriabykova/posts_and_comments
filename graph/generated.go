...
func (ec *executionContext) field_Mutation_createComment_argsComment(
	...
	if tmp, ok := rawArgs["comment"]; ok {
		return ec.unmarshalONewComment2ᚖpostsᚋgraphᚋmodelᚐNewComment(ctx, tmp)
	}
...
func (ec *executionContext) _Comment_replies(ctx context.Context, field graphql.CollectedField, obj *model.Comment) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNCommentsConnection2ᚖpostsᚋgraphᚋmodelᚐCommentsConnection(ctx, field.Selections, res)
}
...
func (ec *executionContext) _CommentsConnection_edges(ctx context.Context, field graphql.CollectedField, obj *model.CommentsConnection) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNCommentsEdge2ᚕᚖpostsᚋgraphᚋmodelᚐCommentsEdgeᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) _CommentsConnection_pageInfo(ctx context.Context, field graphql.CollectedField, obj *model.CommentsConnection) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNPageInfo2ᚖpostsᚋgraphᚋmodelᚐPageInfo(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_createComment(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().CreateComment(rctx, fc.Args["comment"].(*model.NewComment))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) unmarshalInputNewComment(ctx context.Context, obj any) (model.NewComment, error) {
	...
	fieldsInOrder := [...]string{"body", "author", "postId", "parentId"}
...
func (ec *executionContext) marshalNCommentsConnection2postsᚋgraphᚋmodelᚐCommentsConnection(ctx context.Context, sel ast.SelectionSet, v model.CommentsConnection) graphql.Marshaler {
	return ec._CommentsConnection(ctx, sel, &v)
}

func (ec *executionContext) marshalNCommentsConnection2ᚖpostsᚋgraphᚋmodelᚐCommentsConnection(ctx context.Context, sel ast.SelectionSet, v *model.CommentsConnection) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalNCommentsEdge2ᚕᚖpostsᚋgraphᚋmodelᚐCommentsEdgeᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.CommentsEdge) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNCommentsEdge2ᚖpostsᚋgraphᚋmodelᚐCommentsEdge(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNCommentsEdge2ᚖpostsᚋgraphᚋmodelᚐCommentsEdge(ctx context.Context, sel ast.SelectionSet, v *model.CommentsEdge) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalNPageInfo2ᚖpostsᚋgraphᚋmodelᚐPageInfo(ctx context.Context, sel ast.SelectionSet, v *model.PageInfo) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalONewComment2ᚖpostsᚋgraphᚋmodelᚐNewComment(ctx context.Context, v any) (*model.NewComment, error) {
	if v == nil {
		return nil, nil
	}
